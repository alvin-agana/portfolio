          ...
          <div class="page-square">
            ...
            <p>Hover over and click the squares to see some of the cool stuff I've been a part of.</p>
              <div class="work-square-container">
                <WorkSquare name="discordbot" color="blue" title="Discord Bot" 
                ...
                <WorkSquare name="pantry" color="purple" title="The Pantry"
                ...
                <WorkSquare name="dailygoalapp" color="brown" title="Daily Goal Tracker"
                ...
                <WorkSquare name="libretexts" color="yellow" title="LibreTexts"
                ...
                <WorkSquare name="memory" color="brown" title="Memory Game"
                ...
                <WorkSquare name="hackdavis" color="purple" title="HackDavis 2021"
